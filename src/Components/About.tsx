      ...
      >
        ...
        <div className="bs:ml-10 bs:w-3/5 flex flex-col lg-mx:gap-3  bs-mx:items-center">
          ...
          <div className="xs-mx:w-[90%] flex gap-3 xs-mx:justify-between">
            ...
            <Button
              component="a"
              href="https://i.ibb.co/qY3Jt7qG/next-js.png"
              download={Info.name}
        ...
        <div className="h-fit flex justify-center items-center rounded-full bs:mr-10 w-fit">
          <NeonGradientCard className="w-[360px] h-[360px] lg-mx:w-64 lg-mx:h-64 xsm-mx:w-56 xsm-mx:h-56 items-center justify-center text-center">
            <img
              className="w-full h-full rounded-full "
              src={"https://i.ibb.co/Y7BbB87F/profile.png"}
              alt="profile"
            />
          </NeonGradientCard>
        </div>
